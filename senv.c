 ...
 * Return: the value
 */
char *_fgetenv(finfo_a17 *finfo, const char *name)
{
 ...
 *  Return: Always 0
 */
int _funsetenv(finfo_a17 *finfo)
{
	int i;
 ...
 * Return: Always 0
 */
int fpop_env_list(finfo_a17 *finfo)
{
	list_t *node = NULL;
	size_t i;
